 ...
 * 
 * API Endpoints:
 * - GET /api/v1/servers: /api/v1/servers
 * - POST /api/v1/servers: /api/v1/servers
 * - PUT /api/v1/servers/{id}: /api/v1/servers/{id}
 * - DELETE /api/v1/servers/{id}: /api/v1/servers/{id}
 * - POST /api/v1/servers/{id}/start: /api/v1/servers/{id}/start
 * - POST /api/v1/servers/{id}/stop: /api/v1/servers/{id}/stop
 * - POST /api/v1/servers/{id}/restart: /api/v1/servers/{id}/restart
 */
